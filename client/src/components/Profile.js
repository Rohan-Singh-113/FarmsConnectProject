...
export default function Profile() {
  ...
  return (
    <div className="container mx-auto bg-back1 min-h-screen max-h-screen bg-cover bg-center bg-no-repeat max-w-screen-xl mx-auto w-full h-screen pt-1 p-4 flex flex-col justify-around items-center">

      <Toaster position='top-center' reverseOrder={false}></Toaster>

      <div className='flex justify-center items-center h-40%'>
        <div className={`${styles.glass} ${extend.glass}`} style={{ width: "35%", paddingTop: '2px' }}>

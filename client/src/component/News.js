...
const News = (props) => {
  ...
  return (
    ...
    <div className="flex justify-center">
      <div
        className="flex flex-col rounded-lg bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 shadow-xl shadow-gray-800 dark:bg-neutral-700 md:max-w-xl md:flex-row">
        {/* <a href={props.url}> */}
        <img
